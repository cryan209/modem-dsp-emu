# The native MIPS tower, V.8, INFO, and the page-14 handoff

The tower that drives the real firmware, the V.8/INFO chain, and the first V.90 DPCM loads. **Contains the V.90/V.34 page decision** — see the subject index.
