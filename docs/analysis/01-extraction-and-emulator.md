# Extraction, the ADSP-2181 core, and the first live calls

Combifile extraction, the emulator core, the MIPS shim, the SIP endpoint, and the first physical Courier call.
