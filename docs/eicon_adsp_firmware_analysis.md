...
- [Session 202: the budget is not it, and the rate comes from a second array that is mostly zeros](analysis/06-v90-page-decision.md#session-202-the-budget-is-not-it-and-the-rate-comes-from-a-second-array-that-is-mostly-zeros)
