...
- [Session 199: the probe *is* measured — the conversion to a projected rate flattens it](analysis/06-v90-page-decision.md#session-199-the-probe-is-measured--the-conversion-to-a-projected-rate-flattens-it)
